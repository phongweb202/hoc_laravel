...
<form class="m-3" method="POST" action="">
    ...
    <h3 class="alert alert-success">ADD COLOR</h3>
    <div class="mb-3">
        <label for="color_name" class="form-label">Color name</label>
        <input type="text" class="form-control @error('color_name') is-invalid @enderror" value="{{old('color_name')}}" id="color_name" name="color_name">
